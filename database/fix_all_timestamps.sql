-- SQL Script สำหรับแก้ไขเวลาใน database ทั้งหมด
-- ใช้สำหรับแก้ไขปัญหา timestamp ที่ไม่ถูกต้องในทุกตาราง
...
-- แก้ไข created_at และ updated_at ให้เป็นเวลาสุ่มทั้งหมด
-- created_at: สุ่มในช่วงปี 2024 ถึงวันนี้
-- updated_at: สุ่มในช่วง 0-30 วันหลังจาก created_at (แต่ไม่เกินวันนี้)
UPDATE trips
SET 
