...
// Prioritize VITE_API_BASE_URL (full path), then VITE_API_URL (root domain + /api), finally localhost
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 
                     (import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/api` : 'http://localhost:8080/api')
